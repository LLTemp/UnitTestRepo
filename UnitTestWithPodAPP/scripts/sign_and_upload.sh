...
echo "Delete a custom keychain if exists"
security delete-keychain -p ci ios-build.keychain
...
security import ./scripts/certs/dist.p12 -k ~/Library/Keychains/ios-build.keychain -P 1234567890 -A /usr/bin/codesign
...
#################### BUILD ARCHIVE ####################
echo "Archive"
xcodebuild -project ./UnitTestWithPodAPP.xcodeproj -scheme UnitTestWithPodAPP -sdk iphoneos -configuration Release archive -archivePath ./build/UnitTestWithPodAPP.xcarchive
